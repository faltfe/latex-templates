...
\usepackage[%
    ...
    plainfootsepline,                           % Linie Fußzeile Kapitelanfang
    automark,                                   % Einfügen von Section und chapter in Kopfzeile
...
% --- siunitx ---
\sisetup{
%    mode = math,                               % Text wird mit "Mathe"-Schriftart dargestellt
    detect-all,
...
\addbibresource{./bib/referenzen.bib}
